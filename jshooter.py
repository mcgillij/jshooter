...
drawText(
    "Mouse Move", font, windowSurface, (WINDOWWIDTH / 10), (WINDOWHEIGHT / 10) + 50
)
drawText(
    "Mouse Button1 Shoots",
    font,
    windowSurface,
    (WINDOWWIDTH / 10),
    (WINDOWHEIGHT / 10) + 100,
...
drawText(
    "TAB Teleport", font, windowSurface, (WINDOWWIDTH / 10), (WINDOWHEIGHT / 10) + 250
)
drawText(
    "[ & ] Adjust Music Volume",
    font,
    ...
    while True:  # the game loop runs while the game part is playing
        ...
        for event in pygame.event.get():
            ...
            if event.type == MOUSEMOTION:
                ...
                player.rect.move_ip(
                    event.pos[0] - player.rect.centerx,
        ...
        if baddieAddCounter == ADDNEWBADDIERATE:
            ...
            newBaddie = baddie.Baddie(
                ...
                pygame.transform.scale(baddieImage, (baddieSize, baddieSize)),
            )
        ...
        if powerupAddCounter == POWERUPRATE:
            ...
            newPowerup = powerup.Powerup(
                ...
                (
                    pygame.Rect(
                        random.randint(0, WINDOWWIDTH - powerupSize),
                        0 - powerupSize,
                        powerupSize,
                        powerupSize,
                    )
                ...
                powerupSize,
                random.randint(BADDIEMINSPEED, BADDIEMAXSPEED),
                pygame.transform.scale(powerupImage, (powerupSize, powerupSize)),
                POWERUPTYPES[random.randint(0, len(POWERUPTYPES) - 1)],
            )
        ...
        if player.isShooting == True:
            ...
            if bulletAddCounter == SHOTTHROTTLE:
                ...
                newBullet = bullet.Bullet(
                    ...
                    BULLETSPEED,
                    pygame.transform.scale(bulletImage, (bulletSize, bulletSize)),
                    player.rect.centerx,
                    player.rect.centery,
                    "player",
                )
